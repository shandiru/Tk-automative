            ...
            <div>
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-center gap-4 md:gap-6 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#1A1A1A] flex items-center justify-center border border-white/5 group-hover:bg-[#062da3] group-hover:border-[#062da3] transition-all duration-300">
                  ...
                  <div>
                    ...
                    <a href="tel:01624860209" className="text-white text-lg md:text-xl font-semibold hover:text-[#062da3] transition-colors">
                      01624 860209
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 md:gap-6 group">
                  ...
                  <div className="min-w-0">
                    ...
                    <a href="mailto:tkautomotiveiom@gmail.com" className="text-white text-sm md:text-xl font-semibold hover:text-[#062da3] transition-colors break-all">
              ...
              <form className="space-y-5 md:space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                  <div className="flex flex-col">
                    <label className="text-[10px] font-black text-[#062da3] uppercase tracking-[0.2em] mb-2 md:mb-3">First Name</label>
                    <input type="text" placeholder="First Name" className="w-full border-b-2 border-gray-100 py-2 md:py-3 focus:border-[#062da3] outline-none transition-colors text-black font-medium placeholder:text-gray-300" />
                  </div>
                  <div className="flex flex-col">
                    <label className="text-[10px] font-black text-[#062da3] uppercase tracking-[0.2em] mb-2 md:mb-3">Last Name</label>
                    <input type="text" placeholder="Last Name" className="w-full border-b-2 border-gray-100 py-2 md:py-3 focus:border-[#062da3] outline-none transition-colors text-black font-medium placeholder:text-gray-300" />
                  </div>
                </div>

                <div className="flex flex-col">
                  <label className="text-[10px] font-black text-[#062da3] uppercase tracking-[0.2em] mb-2 md:mb-3">Email Address</label>
                  <input type="email" placeholder="your@email.com" className="w-full border-b-2 border-gray-100 py-2 md:py-3 focus:border-[#062da3] outline-none transition-colors text-black font-medium placeholder:text-gray-300" />
                </div>

                <div className="flex flex-col">
                  <label className="text-[10px] font-black text-[#062da3] uppercase tracking-[0.2em] mb-2 md:mb-3">Your Message</label>
                  <textarea placeholder="Tell us about your vehicle and requirements..." rows="4" className="w-full border-b-2 border-gray-100 py-2 md:py-3 focus:border-[#062da3] outline-none transition-colors text-black font-medium resize-none placeholder:text-gray-300 md:rows-5"></textarea>
                </div>

                <button className="w-full bg-[#062da3] hover:bg-black text-white font-bold py-4 md:py-5 rounded-xl md:rounded-2xl transition-all duration-500 uppercase tracking-[0.2em] text-xs md:text-sm shadow-xl shadow-[#062da3]/25 flex items-center justify-center gap-3 group mt-3 md:mt-4">
                  Send Message 
